...
model.plot.transmission(mapbox_access_token='pk.eyJ1Ijoibm9uZGFybG8iLCJhIjoiY2p3ZHNlOHRuMGVvaTQ5bXJrY295czk2aiJ9.tLfzfo2Q6DTKNwfHuTERbQ')
# model.plot.flows()
'''
...
print(resume)
resume.to_csv('resume' + str(c) + '.csv')
